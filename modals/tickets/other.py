...
embed_color = data["Tickets"]["GENERAL_EMBED_COLOR"]
ticket_category_id = data["Tickets"]["TICKET_CATEGORY_ID"]

class OtherSupport(discord.ui.Modal, title='Other Support'):
    ...
    question = discord.ui.TextInput(
        ...
        placeholder='Type how we can help here...',
        max_length=2000,
