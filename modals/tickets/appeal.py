...
class PlayerAppeals(discord.ui.Modal, title='Player Appeals'):
    ...
    punisher = discord.ui.TextInput(
        label='Who punished you?',
        placeholder='Type the punisher here...',
        max_length=50,
        style=discord.TextStyle.short,
    )

    banreason = discord.ui.TextInput(
    ...
    before = discord.ui.TextInput(
        label='Have you been banned before?',
        placeholder="Type if you've been banned before here...",
        max_length=50,
        style=discord.TextStyle.paragraph,
    )

    unbanreason = discord.ui.TextInput(
...
**Punisher**: {self.punisher.value}

**Ban Reason**: {self.banreason.value}

**Ban Before**: {self.before.value}

**Unban Reason**: {self.unbanreason.value}
""", 
